...
export default function Container() {
  return (
    <main className="container">
      ...
      <div className="p-3">
              <h2 className="d-flex justify-content-center">ESCOGE DIETAS PERSONALIZADAS</h2>
            </div>
        <div
        ...
        >
          <div
            className="col-lg-4 col-md-6 col tns-item"
            aria-hidden="true"
            tabIndex={-1}
          >
            <div className="meal-card rounded border active">
              ...
              <div className="w-100 p-3">
                <div className="d-flex justify-content-between py-1">
                  <div className="title">Classic Meal Plan</div>
                  <div className="price">
          ...
          >
            <div className="meal-card rounded border active">
              ...
              <div className="w-100 p-3">
                <div className="d-flex justify-content-between py-1">
                  <div className="title">Clean Meal Plan</div>
                  <div className="price">
                    S/ 62.90 <span>/ semana</span>
                  </div>
                </div>
                <article className="primary-text-color pb-3">
                  Enjoy a balanced approach to clean eating with simply made
          ...
          >
            <div className="meal-card rounded border active">
              ...
              <div className="w-100 p-3">
                <div className="d-flex justify-content-between py-1">
                  <div className="title">Vegan Meal Plan</div>
                  <div className="price">
